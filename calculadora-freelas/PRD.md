...
- **RNF02 - Segurança & Isolamento de Dados (Concluído/Configurado):** Implementação e **configuração realizada** de **Row Level Security (RLS)** no PostgreSQL do Supabase, garantindo que usuários só acessam suas próprias propostas, contratos e configurações fiscais.
