...
import { getBenchmarkServiceById } from '@/modules/pricing/lib'
...
export function Dashboard() {
  ...
  const [layer1, setLayer1] = useState<Awaited<ReturnType<typeof calculateLayer1Action>>>(EMPTY_LAYER1)
  ...
  useEffect(() => {
    ...
    const layer1Input = {
      monthlyExpenses: totalMonthlyExpenses(loadedCosts),
      desiredSalary: loadedCosts.desiredSalary,
      technicalReserve: loadedCosts.technicalReserve,
      profitMargin: loadedCosts.profitMargin / 100,
      availableHours: loadedCosts.availableHours,
      billablePercentage: loadedCosts.billablePercentage,
    }
    calculateLayer1Action(layer1Input).then(setLayer1)
  ...
  const seedDemo = () => {
    ...
    setHasCosts(true)
    const layer1Input = {
      monthlyExpenses: totalMonthlyExpenses(DEFAULT_COSTS),
      desiredSalary: DEFAULT_COSTS.desiredSalary,
      technicalReserve: DEFAULT_COSTS.technicalReserve,
      profitMargin: DEFAULT_COSTS.profitMargin / 100,
                ...
                <Card variant="slab">
                  <CardContent className="flex flex-col gap-[18px]">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <Badge variant="success">Piso técnico ativo</Badge>
                      {profile && (
                        <Badge variant="outline">Regime {profile.taxRegime.replace('_', ' ')}</Badge>
                      )}
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="flex flex-col gap-5">
                    <div className="flex items-start justify-between gap-3 pb-3.5 border-b border-[var(--color-border)]">
                      <div className="flex flex-col gap-1">
                        ...
                        <h3 className="h2 text-[var(--color-text)]">Para onde vai cada real</h3>
                      </div>
                  ...
                  <CardContent className="flex flex-col gap-5">
                    <div className="flex items-start justify-between gap-3 pb-3.5 border-b border-[var(--color-border)]">
                      <div className="flex flex-col gap-1">
                        ...
                        <h3 className="h2 text-[var(--color-text)]">Se você faturar menos horas</h3>
                      </div>
                  ...
                  <CardContent className="flex flex-col gap-4">
                    <div className="flex items-start justify-between gap-3 pb-3.5 border-b border-[var(--color-border)]">
                      <div className="flex flex-col gap-1">
                        ...
                        <h3 className="h2 text-[var(--color-text)]">Onde seu valor-hora se posiciona</h3>
                      </div>
                ...
                <CardContent className="flex flex-col gap-4">
                  <div className="flex flex-wrap items-start justify-between gap-3.5 pb-3.5 border-b border-[var(--color-border)]">
                    <div className="flex flex-col gap-1">
                      ...
                      <h3 className="h2 text-[var(--color-text)]">Evolução do pipeline</h3>
                    </div>
                  ...
                  {chartCount === 0 ? (
                    <div className="flex flex-col gap-2.5 items-start p-8 border border-dashed border-[var(--color-border)] rounded-[var(--radius-md)]">
                      <span className="h3 text-[var(--color-text)]">Sem histórico ainda</span>
              ...
              <Card>
                <div className="flex flex-wrap items-center justify-between gap-3.5 px-6 py-5 border-b border-[var(--color-border)]">
                  <div className="flex flex-col gap-1">
                    ...
                    <h3 className="h2 text-[var(--color-text)]">Orçamentos salvos</h3>
                  </div>
                ...
                {proposals.length === 0 ? (
                  <div className="flex flex-col items-start gap-3.5 px-6 py-9">
                    ...
                    <h4 className="h2 text-[var(--color-text)]">Nenhum orçamento ainda</h4>
                  ...
                  <div className="flex flex-col">
                    {proposals.slice(0, 5).map((p) => (
                      <div key={p.id} className="flex flex-wrap items-center gap-3.5 px-6 py-4 border-b border-[var(--color-hairline)] last:border-b-0">
                        <div className="flex flex-col gap-0.5 flex-1 min-w-[180px]">
                          <span className="h3 text-[var(--color-text)]">
